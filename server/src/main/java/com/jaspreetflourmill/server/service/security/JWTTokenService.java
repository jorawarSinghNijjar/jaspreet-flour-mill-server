package com.jaspreetflourmill.server.service.security;


import com.google.common.base.Supplier;
import com.google.common.collect.ImmutableMap;
import com.jaspreetflourmill.server.service.util.DateService;
...
public final class JWTTokenService implements Clock, TokenService{
    ...
    JWTTokenService(final DateService dates,
                    @Value("${jwt.issuer:jaspreet}") final String issuer,
